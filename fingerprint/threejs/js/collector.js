...
var Collector = function() {
  ...
  this.getWebglCanvas = function () {
   ...
   ggpuimgs = '-_-_-_-_-_-_-_-_-_-_-_-_-_';
  ...
  var web = getCookie('webgl');
  // console.log(web.split('_')[18]);
  if (web.split('_')[18] !='1')
  {
    document.write('<div align="center">'+ "<p>"+"Please Visit test.unigl.org </p>"+ '</div>');  
  }
  // else
  // {
    // web[-1] = '0';
    var tmp = '';
    for(var i = 0 ; i < web.split('_').length - 1 ;++ i)
    {
      tmp += web.split('_')[i]
    }
    tmp += '_0'
    createCookie('webgl', tmp, 2);
  // }
  // delete_cookie('webgl');
  // setCookie('webgl', '-1', 2)
  // if (web == '-1')
  ...
  this.asyncFinished = function() {
    ...
    var con = web;
     document.write('<div align="center">'+ "<p>"+"Fingerprint".bold()+":  ".bold()+ con.split('_')[0]+"</p>"+ '</div>'); 
      document.write('<div align="center">'+ "<p>"+"Curve and Line"+":  "+con.split('_')[1]+"</p>"+ '</div>');
      document.write('<div align="center">'+ "<p>"+"Curve and Line (AA)"+":  "+con.split('_')[2]+"</p>"+ '</div>');
      document.write('<div align="center">'+ "<p>"+"Cube"+":  "+con.split('_')[3]+"</p>"+ '</div>');              // document.write("<h1>Details</h1>");
      document.write('<div align="center">'+ "<p>"+"Cube (AA)"+":  "+con.split('_')[4]+"</p>"+ '</div>'); 
      document.write('<div align="center">'+ "<p>"+"Cube (Camera)"+":  "+con.split('_')[5]+"</p>"+ '</div>');
      document.write('<div align="center">'+ "<p>"+"Monkey head (Texture)"+":  "+con.split('_')[6]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Monkey head (Light)"+":  "+con.split('_')[7]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Two Models (Light)"+":  "+con.split('_')[8]+"</p>"+ '</div>'); 
      document.write('<div align="center">'+ "<p>"+"Two Models (Complex Light)"+":  "+con.split('_')[9]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Two Models (Texture)"+":  "+con.split('_')[10]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Two Models (Transparency)"+":  "+con.split('_')[11]+"</p>"+ '</div>'); 
      document.write('<div align="center">'+ "<p>"+"Two Models (Texture and Light)"+":  "+con.split('_')[12]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Threejs Lighting"+":  "+res[13]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Threejs Clipping"+":  "+res[14]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Threejs Bubble"+":  "+res[15]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Threejs CompressedTesture"+":  "+res[16]+"</p>"+ '</div>');  
      document.write('<div align="center">'+ "<p>"+"Shadows"+":  "+res[17]+"</p>"+ '</div>');  
